-- ====================================================================
-- ВАРИАНТ 3: ГИБРИДНАЯ СТРУКТУРА (Рекомендуется)
-- ====================================================================
...
-- ВАЖНО: Это обновленная структура. Если у вас уже есть старые таблицы,
-- они будут удалены и созданы заново!
...
-- ====================================================================
-- Таблица quiz_sessions - Основная информация о прохождении
-- ====================================================================
CREATE TABLE quiz_sessions (
  ...
  percentage INTEGER NOT NULL DEFAULT 0,       -- Процент правильных ответов (0-100)
  all_answers JSONB,                           -- Полная копия всех ответов для быстрого доступа
  completed_at TIMESTAMP,                      -- Время завершения теста
  created_at TIMESTAMP DEFAULT NOW()           -- Время начала теста
);

-- ====================================================================
-- Таблица quiz_answers - Детальная информация для аналитики
-- ====================================================================
...
-- После прохождения теста данные будут выглядеть так:
--
-- quiz_sessions:
-- {
--   "first_name": "Денис",
